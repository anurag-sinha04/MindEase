...
public class QuizStatistics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] labels = {"well-being and ill-being", "physical health", "control, autonomy and choice",
                "self-perception", "relationships and belonging", "activity",
                "hope and hopelessness", "Stress and Anxiety"};

        int[] colors = {Color.parseColor("#A52A2A"), Color.parseColor("#FF018786"),
                Color.GRAY, Color.parseColor("#7B68EE"), Color.parseColor("#2E7DBC"),
                Color.CYAN, Color.YELLOW, Color.parseColor("#FF7F50")};
        ...
        if (quizDetails.size() < 5) {
            ...
            barChart.setScaleMinima((float) quizDetails.size() / 5f, 1.5f);
        }
