...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        R.drawable.journal, R.drawable.todolist,R.drawable.ic_baseline_show_chart_24,R.drawable.chat};
    ...
    @Override
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {int itemId = item.getItemId(); // Get the ID once
